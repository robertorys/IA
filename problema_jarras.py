...
# Clase nodos para genenerar el árbol
class Nodo():
...
def buscar_solucion(estado_inicial, solucion):
    solcuion_flag = False # Bandera para determinar si se encontró la solución
    ...
    while ((not solcuion_flag) and (len(nodos_frontera) != 0)):
